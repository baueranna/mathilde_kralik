...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" 
    ...
    <xsl:preserve-space elements="tei:body tei:opener tei:closer tei:note tei:salute tei:signed tei:dateline tei:p"/>
             ...
             <body>
                ...
                <section id="metadata">
                    ...
                    <div id="profileDesc">
                        <h1>Briefwechsel</h1>
                        <table>
                           <tr><th>Gesendet:</th><td><xsl:value-of select="//tei:profileDesc/tei:correspDesc/tei:correspAction[@type='sent']/tei:persName"/></td></tr>
                        <tr><th>Empfangen:</th><td><xsl:value-of select="//tei:profileDesc/tei:correspDesc/tei:correspAction[@type='recieved']/tei:persName"/></td></tr>
                        <tr><th>Datum:</th><td><xsl:value-of select="//tei:profileDesc/tei:correspDesc/tei:correspAction[@type='sent']/tei:date"/></td></tr>
                        </table>
                    </div>
                    </div>
                </section>
    ...
    <xsl:template match="tei:body">
        <xsl:apply-templates select="tei:div[@type='letterBody']"/>
    </xsl:template>
    
    <!-- Template for wrapping <pb> and following elements in a content-wrapper -->
    <xsl:template match="tei:div[@type='letterBody']">
    ...
    <xsl:template match="tei:signed">
        <div class="signed"><xsl:apply-templates/></div>
    </xsl:template>
